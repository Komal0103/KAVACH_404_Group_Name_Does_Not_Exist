...
# Function to process frames using Model 1
...
# Function to process frames using Model 2
...
# Function to read video frames and process them
def process_video_frames(video_source):
    ...
    while cap.isOpened():
        ...
        # Create threads to process frames with Model 1 and Model 2
        thread_model1 = threading.Thread(target=process_frame_model1, args=(frame.copy(),))
        thread_model2 = threading.Thread(target=process_frame_model2, args=(frame.copy(),))
...
if __name__ == "__main__":
    ...
    video_thread = threading.Thread(target=process_video_frames, args=(video_source,))
    video_thread.start()
