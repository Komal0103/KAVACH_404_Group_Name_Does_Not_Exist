...
def model1_worker(queue1):
    while True:
        ...
        frame = cv2.rectangle(frame, (500,451), (473,471),(0,255,0) , -1)
        cv2.imshow('object detection',cv2.resize(frame,(600,600)))
        cv2.waitKey(1)
...
def model2_worker(queue2):
    while True:
        ...
        cv2.imshow("Face Recognition",cv2.resize(frame,(800,600)))
        cv2.waitKey(1)
